...
func (r *StockRepo) Store(ctx context.Context, s entity.Stock) error {
	sqlstatement := `INSERT INTO stocks(name, symb, price, curchange, change_in_per) VALUES ($1, $2, $3, $4, $5) ON CONFLICT (symb) DO UPDATE SET price = $3, curchange = $4, change_in_per = $5;`
	go func() {
